                ...
                >
                    <View style={{
                        ...
                        >
                            ...
                            <button onClick={() => router.push(`/`)} className="h-8 my-2 cursor-pointer hover:text-gray-900">
                                <p className="text-black font-semibold text-left capitalize  ">{button1}</p>
                            </button>
                            <button onClick={() => router.push(`/airdrop`)} className="h-8 my-2 cursor-pointer hover:text-gray-900">
                                <p className="text-black font-semibold text-left capitalize ">{button2}</p>
                            </button>
                            <button onClick={() => router.push(`/bounty`)} className="h-8 my-2 cursor-pointer hover:text-gray-900">
                                <p className="text-black font-semibold text-left capitalize ">{button3}</p>
                            </button>
                            <button onClick={() => router.push(`/whitepaper`)} className="h-8 my-2 cursor-pointer hover:text-gray-900">
                                <p className="text-black font-semibold text-left capitalize ">{button4}</p>
                            </button>
                            <button onClick={() => router.push(`/exchanges`)} className="h-8 my-2  cursor-pointer hover:text-gray-900">
                                <p className="text-black font-semibold text-left capitalize ">{button5}</p>
                            </button>
                            <button onClick={() => router.push(`/forum`)} className="h-8 my-2 cursor-pointer hover:text-gray-900">
                                <p className="text-black font-semibold text-left capitalize ">{button6}</p>
                            </button>
                            <button onClick={() => router.push(`/roadmap`)} className="h-8 my-2 cursor-pointer hover:text-gray-900">
                                <p className="text-black font-semibold text-left capitalize ">{button7}</p>
                            </button>
                            <button onClick={() => router.push(`/product`)} className="h-8 my-2 cursor-pointer hover:text-gray-900">
                                <p className="text-black font-semibold text-left capitalize ">{button8}</p>
                            </button>
                            <button onClick={() => router.push(`/partners`)} className="h-8 my-2 cursor-pointer hover:text-gray-900">
                                <p className="text-black font-semibold text-left capitalize ">{button9}</p>
                            </button>
                            <button onClick={() => router.push(`/tokenomics`)} className="h-8 my-2 cursor-pointer hover:text-gray-900">
                                <p className="text-black font-semibold text-left capitalize ">{button10}</p>
                            </button>
                            <button onClick={() => router.push(`/about`)} className="h-8 my-2 cursor-pointer hover:text-gray-900">
