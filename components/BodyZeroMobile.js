...
function BodyZeroMobile() {
    ...
    return (
        <div className="flex flex-col h-auto mt-20">
            ...
            <div className="ml-10 ">
                <div className="w-5/6">
                    <p className=" ">Buy, Sell and Trade Commodities in Minutes</p>
                    <p className=" ">Get Started with as little as 500NGN</p>
                </div>
