...
function Header() {
    return (
        <header className="flex sm:flex-row my-3 justify-between items-center h-auto w-screen">
            <img src="/logo.svg" alt="Apeirox Logo" className="ml-10 h-10 sm:h-12 object-contain" />

            <div className="flex flex-grow items-center justify-end sm:justify-evenly w-xs sm:max-w-xs ">
