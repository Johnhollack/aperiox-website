...
function UseCases() {
    ...
    return (
        <div className="bg-white flex flex-col h-auto w-full px-20 justify-start items-center overflow-hidden py-10 md:py-20">
            <div className="flex flex-col w-full justify-center items-center">
                <p className="text-black font-semibold text-2xl md:text-3xl text-center font-sans ">Use cases</p>
                <div className="w-16 bg-blue-500 h-1 rounded-full mt-1 mb-5"></div>
            </div>

            <div className="flex flex-col md:flex-row w-full items-center justify-evenly my-5 md:my-10">
                <div className="shadow-md flex flex-col mb-10 md:mb-0 drop-shadow justify-between items-center h-60 w-72 bg-white ">
